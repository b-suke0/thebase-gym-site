...
const faqs = [
  ...
  },
  {
    ...
    items: [
      ...
      {
        q: '初回体験とはどんな内容ですか？',
        a: '初回体験（60分）では、現在のお体の状態や目標をヒアリングし、パーソナルトレーナーが一緒にトレーニングします。フォームの確認や器具の使い方もお伝えします。料金は通常3,000円のところ、現在はオープン記念価格1,500円（期間限定）です。',
      },
      {
        q: 'オープン記念価格はいつまでですか？',
        a: '終了時期は決まっていませんが、予告なく終了する場合があります。記念価格のうちにぜひ一度お試しください。',
      },
      {
        q: 'サクセスプランは途中解約できますか？',
  ...
  },
  {
    ...
    items: [
      ...
      {
        q: '動画撮影はできますか？',
        a: 'はい、セルフ利用・パーソナルともに動画撮影OKです。フォームチェックや記録にご活用ください。',
      },
      {
        q: '何人まで利用できますか？',
