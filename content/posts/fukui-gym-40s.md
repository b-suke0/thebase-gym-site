...
> 解決策：**初回体験1,500円**で、まず1回だけ試す。続けるかは後で決められます。
...
|--------|---------|------|------|------|------|
| **THE BASE GYM** | **◎** | **1,000円〜/回** | **完全貸切** | **あり** | **スミスマシン中心** |
...
40代は体の硬さ・古傷・持病など個人差が大きいです。ベーシックプランのパーソナルトレーニングでは、あなたの体の状態を丁寧にヒアリングした上で、無理のないメニューを一緒に考えます。
